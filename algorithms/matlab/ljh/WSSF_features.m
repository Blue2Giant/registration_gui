function [position_1, position_2, Bolb_gradient_cell, Corner_gradient_cell, Bolb_angle_cell, Corner_angle_cell] = WSSF_features(nonelinear_space, E_space, Max_space, Min_space, Phase_space, sigma_1, ratio, Scale_Invariance,nOctaves, save_dir)
    if nargin < 10
        save_dir = '';
    end
    [Bolb_space,Corner_space,Bolb_gradient_cell,Corner_gradient_cell,Bolb_angle_cell,Corner_angle_cell] = WSSF_gradient_feature(nonelinear_space, E_space, Max_space, Min_space, Phase_space, Scale_Invariance,nOctaves, save_dir);
