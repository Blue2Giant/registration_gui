function [matchedPoints1, matchedPoints2, matches] = WSSF_demo_tv_logtv(im1, im2, matchesPath, outDir)
close all;
beep off;
warning('off');
...
try
    ...
    vis_image1 = image_3;
    vis_image2 = image_4;
    if size(vis_image1,3)==1
        vis_image1 = cat(3, vis_image1, vis_image1, vis_image1);
    end
    if size(vis_image2,3)==1
        vis_image2 = cat(3, vis_image2, vis_image2, vis_image2);
    end
    ...
    cp_showMatch(vis_image1, vis_image2, matchedPoints1, matchedPoints2, [], 'matches_vis.jpg', outDir);
    image_fusion(vis_image2, vis_image1, double(H1), outDir);
