...
function cp_showMatch(I1,I2,loc1,loc2,correctPos,save_name,save_dir)
%% ����ȷ��ͼ������ͨ��Ӱ��
[~,~,num_1] =size(I1);
[~,~,num_2] =size(I2);
if num_1>3
...
if nargin < 6 || isempty(save_name)
    save_name = 'matches.jpg';
end
...
frame = getframe(gca);
imwrite(frame.cdata, fullfile(save_dir, save_name));
close(h);
